...
program define psmatch2, sortpreserve
	...
	// generate output
	if ("`outcome'"!="") _mktab `outcome', `ate' `spline' `llr' k(`kerneltype') ai(`ai') n(`neighbor') `population'
...
syntax varlist [, ate spline llr Kerneltype(string) ai(integer 0) Neighbor(integer 1) population]
